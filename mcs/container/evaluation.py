...
from mcs.manager import SubProcEnvManager
from mcs.network import ModularNetwork
from mcs.registry import REGISTRY
from mcs.utils.script_helpers import LogDirHelper
from mcs.utils.util import listd_to_dlist, dtensor_to_dev
...
class EvalContainer:
    def __init__(
        ...
        self.actor = actor_cls.from_args(env_mgr.action_space)
