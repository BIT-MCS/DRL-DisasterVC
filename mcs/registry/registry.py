...
from mcs.actor import ActorModule, ACActorEval
from mcs.agent import AgentModule
from mcs.env import EnvModule
from mcs.exp import ExpModule
from mcs.learner import LearnerModule
from mcs.manager import EnvManagerModule
from mcs.network import NetworkModule
from mcs.network.base.submodule import SubModule
from mcs.rewardnorm import RewardNormModule
from mcs.utils.requires_args import RequiresArgsMixin
...
class Registry:
    ...
    def register_agent(self, agent_class):
        ...
        :param agent_class: mcs.agent.AgentModule. Your custom class.
        :return:
        """
    ...
    def register_actor(self, actor_class):
        ...
        :param actor_class: mcs.actor.ActorModule. Your custom class.
        :return:
        """
    ...
    def register_exp(self, exp_class):
        ...
        :param exp_class: mcs.exp.ExpModule. Your custom class.
        :return:
        """
    ...
    def register_learner(self, learner_cls):
        ...
        :param learner_cls: mcs.learner.LearnerModule. Your custom class.
        :return:
        """
